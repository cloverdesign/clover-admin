...
export const DASHBOARD_DATA: DashboardData = {
  ...
  milestones: [
    ...
    { id: "m2", project: "Site build", client: "Atlas Foods", title: "Staging review", phase: "Development", due: "Jul 30", dueInDays: 5 },
    { id: "m3", project: "Identity", client: "Kite", title: "Logo concepts v2", phase: "Discovery", due: "Aug 02", dueInDays: 8 },
    { id: "m4", project: "Campaign", client: "Muse", title: "Launch assets", phase: "Launch", due: "Aug 05", dueInDays: 11 },
    { id: "m5", project: "Rebrand", client: "Verde Studio", title: "Wireframes", phase: "Design", due: "Aug 06", dueInDays: 12 },
  ],
  projects: [
    ...
    { id: "p2", name: "Site build", client: "Atlas Foods", phase: "Development", progress: 45, nextMilestone: "Staging review", value: "$52k", budget: 52000, status: "at-risk" },
    { id: "p3", name: "Identity", client: "Kite", phase: "Discovery", progress: 20, nextMilestone: "Logo concepts v2", value: "$12k", budget: 12000, status: "on-track" },
    { id: "p4", name: "Campaign", client: "Muse", phase: "Launch", progress: 88, nextMilestone: "Launch assets", value: "$18k", budget: 18000, status: "on-track" },
    { id: "p5", name: "Rebrand", client: "Verde Studio", phase: "Kickoff", progress: 5, nextMilestone: "Wireframes", value: "$30k", budget: 30000, status: "kickoff" },
    { id: "p6", name: "Packaging", client: "Orchard", phase: "Design", progress: 40, nextMilestone: "Dieline review", value: "$16k", budget: 16000, status: "on-track" },
    { id: "p7", name: "Web app", client: "Lumen", phase: "Development", progress: 55, nextMilestone: "Beta cut", value: "$64k", budget: 64000, status: "at-risk" },
    { id: "p8", name: "Motion reel", client: "Fable", phase: "Design", progress: 72, nextMilestone: "Animatic sign-off", value: "$9k", budget: 9000, status: "on-track" },
    { id: "p9", name: "Naming", client: "Kestrel", phase: "Discovery", progress: 15, nextMilestone: "Shortlist", value: "$6k", budget: 6000, status: "on-track" },
  ],
}
