...
export const PROJECTS: Project[] = [
  {
    ...
    type: "Website",
    description:
      "Rebuild the Contoso Foods marketing site on the new design system, with a headless CMS for the editorial team.",
    phase: "Development",
    status: "IN_PROGRESS",
    progress: 62,
    totalValue: 52000,
  ...
  },
  {
    ...
    client: "Relecloud",
    type: "Campaign",
    description: "Launch campaign for the Relecloud spring collection.",
    phase: "Launch",
    status: "REVIEW",
    progress: 88,
    totalValue: 18000,
  ...
  },
  {
    ...
    client: "Proseware",
    type: "Product",
    description: "Customer dashboard for Proseware's energy-monitoring hardware.",
    phase: "Development",
    status: "ON_HOLD",
    progress: 40,
    totalValue: 64000,
  ...
  },
  {
    ...
    client: "Fabrikam",
    type: "Motion",
    description: "Sizzle reel and motion system for Fabrikam's streaming launch.",
    phase: "Design",
    status: "IN_PROGRESS",
    progress: 55,
    totalValue: 9000,
  ...
  },
  {
    ...
    type: "Product",
    description:
      "Revision: extend the Proseware dashboard to native mobile after the web beta.",
    phase: "Kickoff",
    status: "PLANNING",
    progress: 8,
    totalValue: 22000,
